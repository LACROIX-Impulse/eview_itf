...
/**
 * @fn eviewitf_ret_t eviewitf_camera_start(int cam_id)
...
/**
 * @fn eviewitf_ret_t eviewitf_camera_stop(int cam_id)
...
/**
 * @fn eviewitf_ret_t eviewitf_camera_get_attributes(int cam_id, eviewitf_device_attributes_t* attributes)
 ...
 * @return return code as specified by the eviewitf_ret_t enumeration.
 */
eviewitf_ret_t eviewitf_camera_get_digital_gains(int cam_id, uint16_t* dg_cf00, uint16_t* dg_cf01, uint16_t* dg_cf10, uint16_t* dg_cf11);
/* clang-format on */
 ...
 * @return return code as specified by the eviewitf_ret_t enumeration.
 */
eviewitf_ret_t eviewitf_camera_set_digital_gains(int cam_id, uint16_t dg_cf00, uint16_t dg_cf01, uint16_t dg_cf10, uint16_t dg_cf11);
/* clang-format on */
